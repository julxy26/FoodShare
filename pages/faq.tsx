    ...
    <>
      ...
      <SlideInFromRight>
        ...
        <main css={mainContainer}>
          ...
          <p>
            Food waste is the discarding of food that is still fit to be
            consumed. There is food lost or wasted along the chain from farm to
            table. And it’s not just the food itself that goes to waste: it’s
            all the resources that were used in its production - from water to
            land and labour. When food is wasted, it has a harmful effect on the
            environment.
          </p>
          ...
          <p>
            ...
            waste is a complex issue with many actors and occurs across the
